...
class Trainer(object):
    def __init__(self,
                 nnet,
                 checkpoint=r"C:\Users\user\Desktop\教材\自然語言\my_checkpoint",
                 optimizer="adam",
                 gpuid=0,
...
def plot(train_loss_lst, dev_loss_lst, num_epochs):
    ...
    plt.plot(epochs, train_loss_lst, label='Train', color='red')
    plt.plot(epochs, dev_loss_lst, label='Dev', color='blue')
